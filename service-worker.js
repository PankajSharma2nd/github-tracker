...
self.addEventListener('fetch', event => {
    ...
    // For this experiment, let's try to track all github.io requests
    if (url.hostname.endsWith('github.io') && 
        event.request.method === 'GET' && 
        event.request.mode === 'navigate') {
        
        swLog(`GitHub Pages navigation detected: ${event.request.url}`);
...
// If the browser supports the navigation preload API, enable it
...
// Listen for client state changes to track active clients
